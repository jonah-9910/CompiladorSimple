...
namespace AnalizadorSemantico
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (contErrorCompilar == 0)
            {
                using (StreamWriter writer = new StreamWriter("C:\\Users\\USER\\Documents\\GitHub\\CompiladorSimple\\Traduccion.txt", false))
                    ...
                    for (int x = 0; x < pasosPasarAC; x++)
                    {
                        ...
                        writer.WriteLine(pasarAC[x].ToString());
                ...
                string path = "C:\\Users\\USER\\Documents\\GitHub\\CompiladorSimple\\Traduccion.txt";
                ...
                {
                    texto = "No se a logrado realizar la traduccion";
                } 
                textBox2.Text = texto;
            }
